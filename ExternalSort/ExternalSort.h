...
template <typename T, typename Pred, typename EqualPred> class ExternalSort : public IExternalAlgorithm<T>
{
private:
	Pred comparator;
...
public:
	ExternalSort(IDataSource<T> *_dataSource, IDataOutSource<T> *_dataOutSource, string _directoryName, 
		uint _blockSize, Pred _comparator, EqualPred _equalPred)
